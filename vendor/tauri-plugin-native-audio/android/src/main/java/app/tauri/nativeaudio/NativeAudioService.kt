...
private const val TAG = "plugin/native-audio-svc"
            ...
            .setNotificationListener(
                object : PlayerNotificationManager.NotificationListener {
                    override fun onNotificationPosted(notificationId: Int, notification: Notification, ongoing: Boolean) {
                        // Always try to keep the service in the foreground while it is
                        // alive, regardless of `ongoing`. Media3 flips ongoing to false
                        // briefly between tracks (STATE_ENDED -> STATE_BUFFERING), and
                        // re-entering the foreground from a backgrounded app throws
                        ...
                        try {
                            ...
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S &&
                                ...
                                runCatching {
                                    NotificationManagerCompat.from(this@NativeAudioService)
