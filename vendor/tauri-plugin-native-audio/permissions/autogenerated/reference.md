...
`native-audio:allow-seek-to-item`

</td>
<td>

Enables the seek_to_item command without any pre-configured scope.
...
`native-audio:deny-seek-to-item`

</td>
<td>

Denies the seek_to_item command without any pre-configured scope.
