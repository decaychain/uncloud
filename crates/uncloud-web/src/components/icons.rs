...
lucide_icon!(IconPinOff,
    path { d: "m2 2 20 20" }
    path { d: "M12 17v5" }
    path { d: "M15 9.34V7a1 1 0 0 1 1-1 2 2 0 0 0 0-4H7.89" }
    path { d: "M9 9.34V7a1 1 0 0 0-1-1 2 2 0 0 1-1.74-1.01" }
    path { d: "M9 10.76a2 2 0 0 1-1.11 1.79l-1.78.9A2 2 0 0 0 5 15.24V16a1 1 0 0 0 1 1h12" }
);

lucide_icon!(IconExternalLink,
    path { d: "M15 3h6v6" }
    path { d: "M10 14 21 3" }
